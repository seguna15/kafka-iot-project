...
# https://gis.stackexchange.com/questions/450878/finding-all-latitude-and-longitudes-within-x-km-range-from-input-location-using
...
# temperature and heart rate range gotten from https://nadis.org.uk/disease-a-z/cattle/the-healthy-cow/
temperatures = [37, 37.1, 37.2, 37.3, 37.4, 37.5, 37.6, 37.7, 37.8,  37.9, 38, 38.1, 38.2, 38.3, 38.4, 38.5, 38.6, 38.7, 38.8,  38.9, 39,  39.1, 39.2, 39.3, 39.4, 39.5, 39.6, 39.7, 39.8,  39.9, 40, 40.1, 42, 43]
